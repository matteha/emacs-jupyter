...
; TAG CHANGE
(defconst jupyter-repl-input-prompt-format ">>  [    ] ")
;(defconst jupyter-repl-input-prompt-format "In")
;(defconst jupyter-repl-input-prompt-format "")
; TAG CHANGE
(defconst jupyter-repl-output-prompt-format ">>  [    ] ")
;(defconst jupyter-repl-output-prompt-format "Ou")
;(defconst jupyter-repl-output-prompt-format "")
(defconst jupyter-repl-busy-prompt ">*  [    ] ")
;(defconst jupyter-repl-busy-prompt "I*")
...
(cl-defmethod jupyter-send-execute-request ((client jupyter-repl-client)
  ...
  (if code (cl-call-next-method)
    ; disable font lock mode to avoid lag
    (font-lock-mode -1)
    (jupyter-with-repl-buffer client
  ...
  (when (equal execution-state "idle")
    (jupyter-with-repl-buffer client
      (save-excursion
        ...
        ; enable font lock mode again
        (font-lock-mode t)
        ; (jupyter-insert-ansi-coded-text "TEST")
